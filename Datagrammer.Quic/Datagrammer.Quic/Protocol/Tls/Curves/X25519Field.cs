...
namespace Datagrammer.Quic.Protocol.Tls.Curves
{
    public static class X25519Field
    {
        ...
        public static void Add(Span<int> x, Span<int> y, Span<int> z)
        {
        ...
        public static void AddOne(Span<int> z, int zOff)
        {
            z[zOff] += 1;
        }

        public static void Apm(Span<int> x, Span<int> y, Span<int> zp, Span<int> zm)
        {
            for (int i = 0; i < Size; ++i)
            {
                int xi = x[i], yi = y[i];
        ...
        public static void CMov(int cond, Span<int> x, int xOff, Span<int> z, int zOff)
        {
            for (int i = 0; i < Size; ++i)
            {
        ...
        public static void Copy(Span<int> x, int xOff, Span<int> z, int zOff)
        {
            for (int i = 0; i < Size; ++i)
            {
                z[zOff + i] = x[xOff + i];
        ...
        public static void Decode(ReadOnlySpan<byte> x, int xOff, Span<int> z)
        {
        ...
        private static void Decode128(ReadOnlySpan<byte> bs, int off, Span<int> z, int zOff)
        {
        ...
        public static uint Decode32(ReadOnlySpan<byte> bs, int off)
        {
            uint n = bs[off];
            n |= (uint)bs[++off] << 8;
            n |= (uint)bs[++off] << 16;
        ...
        public static void Encode(Span<int> x, Span<byte> z, int zOff)
        {
            Encode128(x, 0, z, zOff);
            Encode128(x, 5, z, zOff + 16);
        }

        private static void Encode128(Span<int> x, int xOff, Span<byte> bs, int off)
        {
        ...
        private static void Encode32(uint n, Span<byte> bs, int off)
        {
            bs[off] = (byte)(n);
            bs[++off] = (byte)(n >> 8);
            bs[++off] = (byte)(n >> 16);
        ...
        public static void Inv(Span<int> x, Span<int> z)
        {
            Span<int> x2 = stackalloc int[Size];
        ...
        public static int IsZero(Span<int> x)
        {
            int d = 0;
        ...
        public static bool IsZeroVar(Span<int> x)
        {
            return 0 != IsZero(x);
        }

        public static void Mul(Span<int> x, int y, Span<int> z)
        {
        ...
        public static void Mul(Span<int> x, Span<int> y, Span<int> z)
        {
            int x0 = x[0], y0 = y[0];
            int x1 = x[1], y1 = y[1];
            int x2 = x[2], y2 = y[2];
        ...
        public static void Negate(Span<int> x, Span<int> z)
        {
            for (int i = 0; i < Size; ++i)
            {
                z[i] = -x[i];
        ...
        private static void PowPm5d8(Span<int> x, Span<int> rx2, Span<int> rz)
        {
            Span<int> x2 = rx2;
            Sqr(x, x2);
            Mul(x, x2, x2);

            Span<int> x3 = stackalloc int[Size];
            Sqr(x2, x3);
            Mul(x, x3, x3);
            ...
            Span<int> x10 = stackalloc int[Size];
            Sqr(x5, 5, x10);
            Mul(x5, x10, x10);

            Span<int> x15 = stackalloc int[Size];
            Sqr(x10, 5, x15);
            Mul(x5, x15, x15);
        ...
        public static void Sqr(Span<int> x, Span<int> z)
        {
            int x0 = x[0];
            int x1 = x[1];
            int x2 = x[2];
        ...
        public static void Sqr(Span<int> x, int n, Span<int> z)
        {
            Sqr(x, z);
        ...
        public static bool SqrtRatioVar(Span<int> u, Span<int> v, Span<int> z)
        {
            Span<int> uv3 = stackalloc int[Size];
            Span<int> uv7 = stackalloc int[Size];
            ...
            Span<int> vx2 = stackalloc int[Size];
            Sqr(x, vx2);
            Mul(vx2, v, vx2);
        ...
        public static void Sub(Span<int> x, Span<int> y, Span<int> z)
        {
            for (int i = 0; i < Size; ++i)
            {
                z[i] = x[i] - y[i];
        ...
        public static void SubOne(Span<int> z)
        {
            z[0] -= 1;
        }
