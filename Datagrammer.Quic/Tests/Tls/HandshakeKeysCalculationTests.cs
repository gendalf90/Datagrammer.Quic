...
namespace Tests.Tls
{
    public class HandshakeKeysCalculationTests
    {
        ...
        public void GenerateSharedSecret_x25519_ResultIsExpected(string publicKey, string privateKey, string expectedResult)
        {
            ...
            //Act
            var result = NamedGroup.X25519.GenerateSharedSecret(privateKeyBytes, publicKeyBytes).ToArray();
        ...
        public void ComputeHelloMessagesHash_Sha256_ResultIsExpected(string clientHelloMessage, string serverHelloMessage, string expectedResult)
        {
            //Arrange
            var amountOfMessageBytes = Utils.ParseHexString(clientHelloMessage + serverHelloMessage);

            //Act
            var result = Hash.Sha256.ComputeHash(amountOfMessageBytes).ToArray();
        ...
        public void CreateHandshakeSecret_Sha256_ResultIsExpected(string sharedSecret, string expectedResult)
        {
            //Arrange
            var sharedSecretBytes = Utils.ParseHexString(sharedSecret);

            //Act
            var result = Hash.Sha256.CreateHandshakeSecret(sharedSecretBytes).ToArray();
        ...
        public void CreateClientHandshakeTrafficSecret_Sha256_ResultIsExpected(string handshakeSecret, string helloHash, string expectedResult)
        {
            //Arrange
            ...
            //Act
            var result = Hash.Sha256.CreateClientHandshakeTrafficSecret(handshakeSecretBytes, helloHashBytes).ToArray();
        ...
        public void CreateHandshakeKey_Sha256_ResultIsExpected(string handshakeTrafficSecret, string expectedResult)
        {
            //Arrange
            var handshakeTrafficSecretBytes = Utils.ParseHexString(handshakeTrafficSecret);

            //Act
            var result = Hash.Sha256.CreateHandshakeKey(handshakeTrafficSecretBytes).ToArray();
        ...
        public void CreateHandshakeIv_Sha256_ResultIsExpected(string handshakeTrafficSecret, string expectedResult)
        {
            //Arrange
            var handshakeTrafficSecretBytes = Utils.ParseHexString(handshakeTrafficSecret);

            //Act
            var result = Hash.Sha256.CreateHandshakeIv(handshakeTrafficSecretBytes).ToArray();
